...
def motion_segmentation(seed_img_file, in_dir, out_dir, threshold, num_frames, blur=None):
    ...
    def _prepare_frame_segment(seed_img, filename=None, img=None, blur=None, as_numeric=True, stretched=True):
        if filename:
    ...
    # -- use `filenames` as input to all `system%d`
    filenames = _prepare_filenames(in_dir, num_frames=150)
        
    def system_1(seed_img, filenames, out_dir, threshold, num_frames=150, as_numeric=True, blur=blur, stretched=True, verbose=True):
        """
    ...
    def system_2(filenames, out_dir, threshold, num_frames=150, num_prev_frames=10, blur=blur, as_numeric=True, stretched=True):
        """
    ...
    def system_3(filenames, out_dir, threshold, num_frames=150, num_prev_frames=10, blur=blur, as_numeric=True, stretched=True):
        """
    ...
    def system_3a(filenames, out_dir, threshold, num_frames=150, num_prev_frames=10, blur=blur, as_numeric=True, stretched=True):
        """
        seed img ~ cumulative moving average
    ...
    def system_4(filenames, out_dir, threshold, num_frames=150, num_prev_frames=10, blur=(7,7), as_numeric=True, stretched=True):
        """
    ...
    def system_5(filenames, out_dir, threshold, num_frames=150, num_prev_frames=10, blur=(3,3), as_numeric=True, stretched=True):
        """
